...
const STATIC_MANAGED_LISTS: ManagedListDefinition[] = [
  ...
  { key: 'CLEARING-DOCUMENT-STATUS', label: 'Clearing Document Status', whereUsed: ['Clearing Documents'] },
  ...
  { key: 'COA-ACCOUNT-ROLE', label: 'Account Role', whereUsed: ['Chart of Accounts'] },
  { key: 'COA-ROLLFORWARD-CATEGORY', label: 'Rollforward Category', whereUsed: ['Chart of Accounts'] },
  ...
  { key: 'CUSTOMER-REFUND-STATUS', label: 'Customer Refund Status', whereUsed: ['Customer Refunds'] },
  { key: 'VENDOR-REFUND-STATUS', label: 'Vendor Refund Status', whereUsed: ['Vendor Refunds'] },
...
const MANAGED_LIST_DEFAULT_VALUES: Record<string, string[]> = {
  ...
  'CLEARING-DOCUMENT-STATUS': ['Draft', 'Pending Approval', 'Approved', 'Posted', 'Void', 'Reversed'],
  'COA-CASH-FLOW-CATEGORY': ['Operating', 'Investing', 'Financing', 'Non-Cash'],
  'COA-ACCOUNT-ROLE': ['Not Applicable', 'Bank Account', 'Cash Account', 'AR Trade', 'AP Trade', 'Deferred Revenue', 'Prepaid Asset', 'FX Gain', 'FX Loss', 'Tax Payable', 'Tax Receivable'],
  ...
  'COA-ROLLFORWARD-CATEGORY': ['Not Applicable', 'Cash and Cash Equivalents', 'Accounts Receivable', 'Inventory', 'Prepaids and Other Current Assets', 'Fixed Assets', 'Accumulated Depreciation and Amortization', 'Accounts Payable', 'Accrued Expenses', 'Deferred Revenue', 'Debt', 'Equity', 'FX Revaluation', 'Intercompany', 'Other Assets', 'Other Liabilities'],
  ...
  'EXCHANGE-RATE-TYPE': ['Spot', 'Average', 'Closing', 'Historical'],
  'FULFILL-STATUS': ['Pending', 'Shipped', 'Delivered', 'Cancelled'],
  'INV-STATUS': ['Draft', 'Open', 'Paid', 'Void'],
  'INV-RECEIPT-STATUS': ['Draft', 'Posted', 'Void'],
  'CUSTOMER-REFUND-STATUS': ['Draft', 'Processed', 'Void'],
  'VENDOR-REFUND-STATUS': ['Draft', 'Processed', 'Void'],
  'JOURNAL-STATUS': ['Draft', 'Pending Approval', 'Approved', 'Posted', 'Void', 'Reversed'],
