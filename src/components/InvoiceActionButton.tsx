...
export default function InvoiceActionButton({
  ...
  return (
    <div className="flex flex-col items-start gap-1">
      <button type="button" onClick={handleClick} disabled={saving} className={`inline-flex items-center rounded-md px-3 py-1.5 text-xs font-semibold text-white ${styles[tone]}`}>
        {saving ? 'Saving...' : label}
      </button>
