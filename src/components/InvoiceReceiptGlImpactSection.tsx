...
export type InvoiceReceiptGlImpactRow = {
  id: string
...
export default function InvoiceReceiptGlImpactSection({ rows }: { rows: InvoiceReceiptGlImpactRow[] }) {
  ...
  return (
    ...
    >
      {rows.length === 0 ? (
        <RecordDetailEmptyState message="No posted accounting impact is linked to this invoice receipt yet." />
      ) : (
        <>
